#open the site https://www.onemotion.com/drum-machine/ and go to pads , keep it open in the backgroud to make this work. Open the site, run the program and click 
#on the opened tab and start drumming :)  
